...
//! - `migration/` — forward-pointer migration markers for the eventual
//!   pass-2 DNA-hash change: `mark_migrated` / `mark_migrated_v2` write
//!   externs + `get_migration_marker` / `get_migration_marker_v2`
