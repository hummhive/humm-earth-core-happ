//! Conductor proof for the coordinator liveness and paged Inbox riders:
//! `list_by_acl_link` liveness parity and `probe_inbox_page` composite cursors.
...
use support::{
    ...
    GenesisResponse, SourcePosition,
};
...
async fn delete_content(
    ...
    let delete_action_hash: ActionHash = conductor
...
async fn acl_list_carries_the_liveness_rider() {
    ...
    let _delete_action_hash: ActionHash = delete_content(
        &conductor,
        &zome,
